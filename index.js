...
app.use(session({
  ...
  store: MongoStore.create({
    mongoUrl: `mongodb+srv://${process.env.MONGO_USER}:${process.env.MONGO_PASSWORD}@cluster0.1r3c2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`,  // Your MongoDB URI
  })
}));
